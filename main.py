...
sns.scatterplot(x=X_pca[:, 0], y=X_pca[:, 1], hue=y_bal.map({0: 'No', 1: 'Yes'}),
...
sns.stripplot(x=X_lda[:, 0], y=y_bal.map({0: 'No', 1: 'Yes'}),
              palette='Set1', ax=axes[1], jitter=0.2)
...
# ------------------------------
# 13. Hyperparameter tuning for SVM (RBF)
# ------------------------------
param_grid = {
    'C': [0.1, 1, 10, 100],
